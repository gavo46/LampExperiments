...
Configuration
config.py holds the tunable values — camera index, audio thresholds, and MEASURE, which toggles the instrumentation used to produce the numbers in the technical note.
Project structure
...
robot/         supplied URDF and mesh assets
